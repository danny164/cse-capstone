    ...
    <div class="breadcrumb-bar navbar bg-white sticky-top">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ url('admin/groups/edit') }}">Edit Semester</a>
                <a class="dropdown-item" href="#">Share</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item text-chartjs" href="#"><i class="fas fa-lock-alt"></i>Close Semester</a>
                                ...
                                <table id="team-list" class="stripe" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"></a><span class="ic-dark"><i class="fad fa-pencil"></i></span></a>
                        ...
                        <div class="content-list">
                            ...
                            <div class="row justify-content-center">
                                <div class="table-responsive mt-3">
                                    ...
                                    <table id="show-semester-members" class="stripe" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th></th>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#show-semester-members').DataTable({
                'columnDefs': [
                    {
                        'targets': 0,
                        'checkboxes': {
